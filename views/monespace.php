            ...
            <section class="card" style="max-width: 600px; width: 100%; margin: 48px auto 32px auto; text-align: center; background: #181818; color: #fff; box-shadow:0 8px 32px #0004; border-radius:18px;">
                ...
                <div style="margin-bottom:18px;color:#1e5d2d;font-weight:bold;">Votre espace personnel</div>
                                <div class="user-info" style="margin-bottom:18px;display:flex;flex-direction:column;gap:8px;align-items:center;">
                                    <div style="background:#f5f5f5;border-radius:14px;padding:22px 28px;min-width:220px;max-width:340px;box-shadow:0 2px 8px #3bb54a22;border:1.5px solid #e0f2e9;color:#222;text-align:left;">
                                        <div style="margin-bottom:8px;"><strong style="color:#1e5d2d;">Nom :</strong> <span id="user-lastname" style="color:#222;"></span></div>
                                        <div style="margin-bottom:8px;"><strong style="color:#1e5d2d;">Prénom :</strong> <span id="user-firstname" style="color:#222;"></span></div>
                                        <div style="margin-bottom:8px;"><strong style="color:#1e5d2d;">Email :</strong> <span id="user-email" style="color:#222;"></span></div>
                                        <div><strong style="color:#1e5d2d;">Téléphone :</strong> <span id="user-telephone" style="color:#222;"></span></div>
                                    </div>
                                </div>
                <a href="/MyStadium/views/logout.php" class="btn-main" style="width:100%;margin-bottom:8px;">Se déconnecter</a>
                                ...
                                async function chargerInfosUtilisateur() {
                                    try {
                                        ...
                                        // Affiche une erreur claire et ne bloque pas la page
                                        const card = document.querySelector('.card');
                                        if(card) {
                                            card.innerHTML = '<div style="color:#c62828;font-weight:bold;padding:32px 0;">Erreur lors du chargement de vos informations.<br>'+e.message+'</div>';
                                        }
                                    }
                                }
